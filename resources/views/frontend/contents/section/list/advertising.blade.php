        ...
        <div class="container">
            <div class="banner-content">
                ...
                <div class="list-breadcrumb">
                    <ul>
                        <li><a href="">Home</a></li>
                        <li class="current">Advertising</a></li>
                    </ul>
                </div>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-xl-9">
                        <div class="list-platinum">
                            <div class="row">
                                @foreach ($data['read']['posts']->filter(fn($post) => in_array('10', $post['category_id'])) as $post)
                                    <div class="col-md-6">
                                        <a href="{{ route('content.post.read.' . $post->section->slug, ['slugPost' => $post->slug]) }}"
                                            class="item-iklan platinum">
                                            <div class="box-img">
                                                <div class="thumbnail-img">
                                                    <img src="{{ asset($post['cover_src']) }}" alt="">
                                                </div>
                                            </div>
                                            <div class="box-post">
                                                <div class="lable-member">Platinum</div>
                                                <h4 class="title-post" title="Making steel in the 2020s">
                                                    {{ $post->fieldLang('title') }}
                                                </h4>
                                                <article class="summary-content">
                                                    {!! $post->fieldLang('intro') !!}
                                                </article>
                                                <div href="{{ route('content.post.read.' . $post->section->slug, ['slugPost' => $post->slug]) }}"
                                                    class="line-btn justify-content-end">
                                                    <span>Read More</span>
                        ...
                        <div class="list-gold">
                            <div class="row">
                                @foreach ($data['read']['posts']->filter(fn($post) => in_array('11', $post['category_id'])) as $post)
                                    <div class="col-md-6">
                                        <a href="{{ route('content.post.read.' . $post->section->slug, ['slugPost' => $post->slug]) }}"
                                            class="item-iklan gold">
                                            <div class="box-img">
                                                <div class="thumbnail-img">
                                                    <img src="{{ asset($post['cover_src']) }}" alt="">
                                                </div>
                                            ...
                                            <div class="box-post">
                                                <div class="lable-member">Gold</div>
                                                <h4 class="title-post" title="Making steel in the 2020s">
                                                    {{ $post->fieldLang('title') }}
                                                </h4>
                                                <article class="summary-content">
