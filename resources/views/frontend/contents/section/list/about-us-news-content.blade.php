                ...
                <div class="row g-0">
                    <div class="col-lg-8">
                        <div class="main-title">
                            ...
                            <h1 class="title fw-700 title-display-2 text-uppercase split-text line-height-sm text-white">{{ $data['read']['header_text'] ? $data['read']->fieldLang('header_text') : __('text.header_title_2')}}</h1>
                        </div>
                    </div>
                </div>
            </div>
