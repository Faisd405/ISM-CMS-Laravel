    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex w-100 w-xl-auto">
                    ...
                    <a href="{{ route('content.section.create', $queryParam) }}" class="btn btn-success icon-btn-only-sm btn-sm mr-2" title="@lang('global.add_attr_new', [
                            'attribute' => __('module/content.section.caption')
                        ])">
                        <i class="las la-plus"></i> <span>@lang('module/content.section.caption')</span>
                    </a>
                    @endcan
                    @role('developer|super')
                    <a href="{{ route('content.section.trash') }}" class="btn btn-secondary icon-btn-only-sm btn-sm" title="@lang('global.trash')">
        ...
        <div class="card">
            <div class="card-header with-elements">
                <h5 class="card-header-title mt-1 mb-0">@lang('module/content.section.text')</h5>
            </div>
                ...
                <table class="table card-table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('module/content.section.label.field1')</th>
                    ...
                    <tbody class="{{ $data['sections']->total() > 1 && isset(config('cms.module.content.section.ordering')['position']) ? 'drag' : ''}}">
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('content.category.index', ['sectionId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-warning" title="@lang('module/content.category.caption')">
                                ...
                                <a href="{{ route('content.post.index', ['sectionId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-success" title="@lang('module/content.post.caption')">
                                    <i class="las la-list"></i>
                                </a>
                                @endif
                                @endcan
                                @can('content_section_update')
                                <a href="{{ route('content.section.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-primary" title="@lang('global.edit_attr', [
                                    'attribute' => __('module/content.section.caption')
                                ])">
