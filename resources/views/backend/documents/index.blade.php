    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('module/document.text')
                </h5>
                <div class="box-btn">
                    @can ('document_create')
                    <a href="{{ route('document.create', $queryParam) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('module/document.caption')
                        ])">
                        <i class="fi fi-rr-add"></i>
                        <span>@lang('module/document.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('document.trash') }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('module/document.label.name')</th>
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    @can('document_files')
                                    <a href="{{ route('document.file.index', ['documentId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-main" title="@lang('module/document.file.caption')">
                                        <i class="fi fi-rr-folder"></i>
                                    </a>
                                    @endcan
                                    @can('document_update')
                                    <a href="{{ route('document.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-success" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/document.caption')
                                    ])">
            ...
            <div class="card-footer justify-content-center justify-content-lg-between align-items-center flex-wrap">
                <div class="text-muted mb-3 m-lg-0">
                    ...
                    <strong>{{ $data['documents']->firstItem() }}</strong> - 
                    <strong>{{ $data['documents']->lastItem() }}</strong> 
                    @lang('pagination.of')
