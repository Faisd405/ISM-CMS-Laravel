                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('district.index', ['provinceCode' => $item['province_code'], 'cityCode' => $item['code']]) }}" class="btn btn-warning icon-btn btn-sm" title="@lang('module/regional.city.caption')">
