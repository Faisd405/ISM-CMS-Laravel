                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-danger icon-btn btn-sm swal-delete" data-province-code="{{ $item['province_code'] }}" 
                                    data-city-code="{{ $item['city_code'] }}" data-id="{{ $item['id'] }}" title="@lang('global.delete')">
