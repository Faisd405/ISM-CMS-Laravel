    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex w-100 w-xl-auto">
                    @can('regional_create')
                    <a href="{{ route('district.create', ['provinceCode' => $data['city']['province_code'], 'cityCode' => $data['city']['code']]) }}" class="btn btn-success icon-btn-only-sm btn-sm mr-2" title="@lang('global.add_attr_new', [
        ...
        <div class="card">
            <div class="card-header with-elements">
                <h5 class="card-header-title mt-1 mb-0">@lang('module/regional.district.text') <span class="badge badge-primary">{{ $data['city']['province']['name'] }}</span> <span class="badge badge-info">{{ $data['city']['name'] }}</span></h5>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @can('regional_update')
                                <a href="{{ route('district.edit', ['provinceCode' => $item['province_code'], 'cityCode' => $item['city_code'], 'id' => $item['id']]) }}" class="btn btn-primary icon-btn btn-sm" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/regional.district.caption')
                                    ])">
