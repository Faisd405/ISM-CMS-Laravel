    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('module/regional.district.text')
                </h5>
                <div class="box-btn">
                    @can('regional_create')
                    <a href="{{ route('district.create', array_merge(['provinceCode' => $data['city']['province_code'], 'cityCode' => $data['city']['code']], $queryParam)) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('module/regional.district.caption')
                        ])">
                        <i class="fi fi-rr-add"></i>
                        <span>@lang('module/regional.district.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('district.trash', ['provinceCode' => $data['city']['province_code'], 'cityCode' => $data['city']['code']]) }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 50px;">@lang('module/regional.district.label.code')</th>
                            <th>@lang('module/regional.district.label.name')</th>
                            <th>@lang('module/regional.district.label.latitude')</th>
                            <th>@lang('module/regional.district.label.longitude')</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    @can('regional_update')
                                    <a href="{{ route('district.edit', array_merge(['provinceCode' => $item['province_code'], 'cityCode' => $item['city_code'], 'id' => $item['id']], $queryParam)) }}" class="btn btn-success icon-btn btn-sm" 
            ...
            <div class="card-footer justify-content-center justify-content-lg-between align-items-center flex-wrap">
                <div class="text-muted mb-3 m-lg-0">
                    ...
                    <strong>{{ $data['districts']->firstItem() }}</strong> - 
                    <strong>{{ $data['districts']->lastItem() }}</strong> 
                    @lang('pagination.of')
