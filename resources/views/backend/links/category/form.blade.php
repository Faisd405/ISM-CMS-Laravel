    ...
    <div class="col-xl-9 col-lg-9 col-md-9">
        ...
        <div class="card">
            ...
            <form action="{{ !isset($data['category']) ? route('link.category.store', $queryParam) : 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control slug_spot @error('slug') is-invalid @enderror" lang="{{ App::getLocale() }}" name="slug"
                                    value="{{ !isset($data['category']) ? old('slug') : old('slug', $data['category']['slug']) }}" placeholder="{{ url('/') }}/link/SLUG">
                ...
                <hr class="m-0">
                <div class="card-body">
                    <h6 class="font-weight-semibold mb-4">MEDIA SETTING</h6>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Media perpage</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control mb-1 @error('media_perpage') is-invalid @enderror" name="media_perpage" 
                                value="{{ !isset($data['category']) ? old('media_perpage') : old('media_perpage', $data['category']['media_perpage']) }}" 
                                placeholder="limit list media">
                            @include('components.field-error', ['field' => 'media_perpage'])
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @role('super')
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">@lang('module/link.category.label.field5')</label>
                        <div class="col-sm-10">
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                  ...
                                  <span class="form-check-label">
                                    @lang('module/link.category.label.field3')
                                  </span>
                                </label>
                                <label class="form-check form-check-inline">
