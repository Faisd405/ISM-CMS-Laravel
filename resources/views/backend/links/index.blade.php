    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('module/link.text')
                </h5>
                <div class="box-btn">
                    @can ('link_create')
                    <a href="{{ route('link.create', $queryParam) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('module/link.caption')
                        ])">
                        <i class="fi fi-rr-add"></i>
                        <span>@lang('module/link.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('link.trash') }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('module/link.label.name')</th>
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    @can('link_medias')
                                    <a href="{{ route('link.media.index', ['linkId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-main" title="@lang('module/link.file.caption')">
                                        <i class="fi fi-rr-link"></i>
                                    </a>
                                    @endcan
                                    @can('link_update')
                                    <a href="{{ route('link.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-success" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/link.caption')
                                    ])">
                                    ...
                                    @can('link_delete')
                                        ...
                                        @endif
                                    @endcan
                                    @if (Auth::user()->hasRole('developer|super|support|admin') && config('cms.module.link.approval') == true)
            ...
            <div class="card-footer justify-content-center justify-content-lg-between align-items-center flex-wrap">
                <div class="text-muted mb-3 m-lg-0">
                    ...
                    <strong>{{ $data['links']->firstItem() }}</strong> - 
                    <strong>{{ $data['links']->lastItem() }}</strong> 
                    @lang('pagination.of')
