    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex w-100 w-xl-auto">
                    @role('super')
                    <a href="{{ route('url.create') }}" class="btn btn-success icon-btn-only-sm btn-sm mr-2" title="@lang('global.add_attr_new', [
                            'attribute' => __('module/url.caption')
                        ])">
                        <i class="las la-plus"></i> <span>@lang('module/url.caption')</span>
                    </a>
                    <a href="{{ route('url.trash') }}" class="btn btn-secondary icon-btn-only-sm btn-sm" title="@lang('global.trash')">
        ...
        <div class="card">
            <div class="card-header with-elements">
                <h5 class="card-header-title mt-1 mb-0">@lang('module/url.text')</h5>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('url.edit', ['id' => $item['id']]) }}" class="btn btn-primary icon-btn btn-sm" title="@lang('global.edit_attr', [
                                    'attribute' => __('module/url.caption')
                                ])">
