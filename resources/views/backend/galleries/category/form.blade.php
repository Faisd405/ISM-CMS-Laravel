...
<div class="row justify-content-center">
    <div class="col-xl-9 col-lg-9 col-md-9">
        ...
        <div class="card">
            ...
            <form action="{{ !isset($data['category']) ? route('gallery.category.store') : 
                route('gallery.category.update', ['id' => $data['category']['id']]) }}" method="POST">
                @csrf
                @isset($data['category'])
                    @method('PUT')
                @endisset
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control slug_spot @error('slug') is-invalid @enderror" lang="{{ App::getLocale() }}" name="slug"
                                    value="{{ !isset($data['category']) ? old('slug') : old('slug', $data['category']['slug']) }}" placeholder="{{ url('/') }}/gallery/cat/SLUG">
                ...
                <hr class="m-0">
                <div class="card-body">
                    <h6 class="font-weight-semibold mb-4">ALBUM SETTING</h6>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Album perpage</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control mb-1 @error('album_perpage') is-invalid @enderror" name="album_perpage" 
                                value="{{ !isset($data['category']) ? old('album_perpage') : old('album_perpage', $data['category']['album_perpage']) }}" 
                                placeholder="limit list album">
                            @include('components.field-error', ['field' => 'album_perpage'])
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">@lang('module/gallery.category.label.field6')</label>
                        <div class="col-sm-10">
                    ...
                    @else
                    <input type="hidden" name="template_list_id" value="{{ !isset($data['category']) ? null : $data['category']['template_list_id'] }}">
                    <input type="hidden" name="template_detail_id" value="{{ !isset($data['category']) ? null : $data['category']['template_detail_id'] }}">
                    @endrole
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">@lang('module/gallery.category.label.field4')</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="form-control" id="image1" aria-label="Image" aria-describedby="button-image" name="image_file"
                                        value="{{ !isset($data['category']) ? old('image_file') : old('image_file', $data['category']['image_preview']['filepath']) }}">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="@lang('global.title')" name="image_title" value="{{ !isset($data['category']) ? old('image_title') : old('image_title', $data['category']['image_preview']['title']) }}">
                                </div>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="@lang('global.alt')" name="image_alt" value="{{ !isset($data['category']) ? old('image_alt') : old('image_alt', $data['category']['image_preview']['alt']) }}">
                                </div>
                            </div>
                        </div>
                    </div>
