                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="image-upload">
                        <div class="col-md-2 text-md-right">
                            <label class="col-form-label text-sm-right">@lang('module/gallery.file.label.field3')</label>
                        </div>
                        <div class="col-md-10">
                            ...
                            [<span class="text-muted">Type of file : <strong>{{ Str::upper(config('cms.files.gallery.mimes')) }}</strong></span>] - 
                            [<span class="text-muted">Pixel : <strong>{{ config('cms.files.gallery.pixel') }}</strong></span>] - 
                    ...
                    <div class="form-group row" id="image-url">
                        <label class="col-form-label col-sm-2 text-sm-right">@lang('module/gallery.file.label.field6')</label>
                        <div class="col-sm-10">
                    ...
                    <div id="video-upload">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                [<span class="text-muted">Type of file : <strong>{{ Str::upper(config('cms.files.gallery.mimes_video')) }}</strong></span>] - 
                                [<span class="text-muted">Pixel : <strong>{{ config('cms.files.gallery.pixel') }}</strong></span>] - 
                                [<span class="text-muted">Max Size : <strong>{{ config('cms.files.gallery.size') }}</strong></span>]
                            </div>
                        </div>
                    ...
                    <div class="form-group row" id="video-youtube">
                        <label class="col-form-label col-sm-2 text-sm-right">@lang('module/gallery.file.label.field5')</label>
                        <div class="col-sm-10">
                            ...
                            <div class="form-group row {{ isset($data['file']) && $data['file']['config']['show_title'] == false ? 'hide-form' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control mb-1 @error('title_'.$lang['iso_codes']) is-invalid @enderror" lang="{{ $lang['iso_codes'] }}" 
                                        ...
                                        placeholder="@lang('module/gallery.file.placeholder.field1')">
