    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex w-100 w-xl-auto">
                    ...
                    <a href="{{ route('gallery.album.create') }}" class="btn btn-success icon-btn-only-sm btn-sm mr-2" title="@lang('global.add_attr_new', [
        ...
        <div class="card">
            <div class="card-header with-elements">
                <h5 class="card-header-title mt-1 mb-0">@lang('module/gallery.album.text')</h5>
            </div>
                ...
                <table class="table card-table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @can('gallery_files')
                                <a href="{{ route('gallery.file.index', ['albumId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-success" title="@lang('module/gallery.file.caption')">
                                    <i class="las la-file-archive"></i>
                                </a>
                                @endcan
                                @can('gallery_album_update')
                                <a href="{{ route('gallery.album.edit', ['id' => $item['id']]) }}" class="btn icon-btn btn-sm btn-primary" title="@lang('global.edit_attr', [
                                    'attribute' => __('module/gallery.album.caption')
                                ])">
                ...
                <div class="card-footer">
                    <div class="row align-items-center">
                        <div class="col-lg-6 m--valign-middle">
                            @lang('pagination.showing') : <strong>{{ $data['albums']->firstItem() }}</strong> - <strong>{{ $data['albums']->lastItem() }}</strong> @lang('pagination.of')
