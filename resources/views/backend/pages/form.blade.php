                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2 hide-form">
                            ...
                            <label class="custom-control custom-checkbox m-0">
                                ...
                                @if (!isset($data['page']) && old('config_show_header_text', 1))
                                    checked
                                @elseif(isset($data['page']['config']['show_header_text']) && old('config_show_header_text', $data['page']['config']['show_header_text']) == 1)
                                    checked
