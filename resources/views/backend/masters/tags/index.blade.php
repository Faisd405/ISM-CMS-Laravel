    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('master/tags.text')
                </h5>
                <div class="box-btn">
                    @can('tag_create')
                    <a href="{{ route('tags.create', $queryParam) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('master/tags.caption')
                        ])">
                        <i class="fi fi-rr-add"></i>
                        <span>@lang('master/tags.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('tags.trash') }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content pb-0" action="" method="GET">
                            ...
                            <div class="modal-body mt-3">
                                ...
                                <div class="form-group">
                                    <label class="form-label">@lang('master/tags.label.flags')</label>
                                    <select class="form-control" name="flags">
                                ...
                                <div class="form-group">
                                    <label class="form-label">@lang('master/tags.label.standar')</label>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('master/tags.label.name')</th>
                            <th>@lang('master/tags.label.description')</th>
                            <th class="text-center" style="width: 100px;">@lang('master/tags.label.flags')</th>
                            <th class="text-center" style="width: 100px;">@lang('master/tags.label.standar')</th>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ !empty($item['description']) ? strip_tags($item['description']) : __('global.field_empty_attr', [
                                    'attribute' => __('master/tags.label.description')
                                    ]) }}
                            </td>
                            <td class="text-center">
                                @if (Auth::user()->hasRole('developer|super|support|admin') && Auth::user()->can('tag_update'))
                                <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item['flags'] == 1 ? 'primary' : 'danger' }}"
                                    title="@lang('master/tags.label.flags')">
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item['standar'] == 1 ? 'info' : 'secondary' }}"
                                    title="@lang('master/tags.label.standar')">
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    @can('tag_update')
                                    <a href="{{ route('tags.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-success" 
            ...
            <div class="card-footer justify-content-center justify-content-lg-between align-items-center flex-wrap">
                <div class="text-muted mb-3 m-lg-0">
                    ...
                    <strong>{{ $data['tags']->firstItem() }}</strong> - 
                    <strong>{{ $data['tags']->lastItem() }}</strong> 
                    @lang('pagination.of')
