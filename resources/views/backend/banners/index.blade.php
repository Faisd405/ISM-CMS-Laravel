    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex w-100 w-xl-auto">
                    @can('banner_create')
                    <a href="{{ route('banner.create', $queryParam) }}" class="btn btn-success icon-btn-only-sm btn-sm mr-2" title="@lang('global.add_attr_new', [
                    ...
                    <a href="{{ route('banner.trash') }}" class="btn btn-secondary icon-btn-only-sm btn-sm" title="@lang('global.trash')">
                ...
                <table class="table card-table table-striped table-hover">
                    ...
                    <tbody class="{{ $data['banners']->total() > 1 && isset(config('cms.module.banner.ordering')['position']) ? 'drag' : ''}}">
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td class="text-center">
                                @can('banner_files')
                                <a href="{{ route('banner.file.index', ['bannerId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-success" title="@lang('module/banner.file.caption')">
                                    <i class="las la-list"></i>
                                </a>
                                @endcan
                                @can('banner_update')
                                <a href="{{ route('banner.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn btn-primary icon-btn btn-sm" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/banner.caption')
                                    ])">
