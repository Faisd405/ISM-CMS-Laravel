...
<div class="row justify-content-center">
    <div class="col-xl-9 col-lg-9 col-md-9">
        ...
        <div class="card">
            ...
            <form action="{{ !isset($data['category']) ? route('banner.category.store', $queryParam) : 
                route('banner.category.update', array_merge(['id' => $data['category']['id']], $queryParam)) }}" method="POST">
                @csrf
                @isset($data['category'])
                    @method('PUT')
                @endisset
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade {{ $lang['iso_codes'] == config('cms.module.feature.language.default') ? 'show active' : '' }}" id="{{ $lang['iso_codes'] }}">
                        <div class="card-body pb-2">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-2 text-sm-right">@lang('module/banner.category.label.field1') <i class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control mb-1 @error('name_'.$lang['iso_codes']) is-invalid @enderror" lang="{{ $lang['iso_codes'] }}" 
                                        ...
                                        placeholder="@lang('module/banner.category.placeholder.field1')">
                                    @include('components.field-error', ['field' => 'name_'.$lang['iso_codes']])
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-sm-2 text-sm-right">@lang('module/banner.category.label.field2')</label>
                                <div class="col-sm-10">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">@lang('module/banner.category.label.field3')</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('banner_perpage') is-invalid @enderror" name="banner_perpage"
                                    value="{{ !isset($data['category']) ? old('banner_perpage') : old('banner_perpage', $data['category']['banner_perpage']) }}" placeholder="limit banner">
                                @include('components.field-error', ['field' => 'banner_perpage'])
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                  ...
                                  <span class="form-check-label">
                                    @lang('module/banner.category.label.field2')
                                  </span>
                                </label>
                            </div>
                        </div>
