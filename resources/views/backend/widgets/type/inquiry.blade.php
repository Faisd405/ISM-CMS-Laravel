<div class="form-group row">
    ...
    <div class="col-md-10">
        @if(isset($data['widget']) && $data['widget']['type'] == 'inquiry')
        <input type="hidden" name="moduleable_id" value="{{ $data['widget']['moduleable_id'] }}">
        <input id="moduleable" type="text" class="form-control mb-1" value="{!! $data['widget']['module']['inquiry']->fieldLang('name') !!}" readonly>
        @endif
