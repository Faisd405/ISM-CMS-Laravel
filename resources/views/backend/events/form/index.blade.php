...
<div class="row justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card" id="export-card">
            <div class="card-body" >
                <form action="{{ route('event.form.export', ['eventId' => $data['event']['id']]) }}" method="POST">
                    @csrf
                    <div class="form-row align-items-center">
                        <div class="col-md-2">
                            <div class="form-group">
        ...
        <div class="card">
            <div class="card-header with-elements">
                <h5 class="card-header-title mt-1 mb-0">@lang('module/event.form.text') <span class="badge badge-primary">{!! $data['event']->fieldLang('name') !!}</span></h5>
            </div>
                ...
                <table class="table card-table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px;">@lang('module/event.form.label.field2')</th>
                            <th style="width: 230px;">@lang('module/event.form.label.field3')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:;" data-event-id="{{ $item['event_id'] }}" data-id="{{ $item['id'] }}" class="btn icon-btn btn-sm btn-danger swal-delete" title="@lang('global.delete_attr', [
