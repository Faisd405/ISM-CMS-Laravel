    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('module/inquiry.text')
                </h5>
                <div class="box-btn">
                    @can ('inquiry_create')
                    <a href="{{ route('inquiry.create', $queryParam) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('module/inquiry.caption')
                        ])">
                        <i class="fi fi-rr-add"></i>
                        <span>@lang('module/inquiry.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('inquiry.trash') }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('module/inquiry.label.name')</th>
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    ...
                                    <a href="{{ route('inquiry.form', ['inquiryId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-main" title="@lang('module/inquiry.form.caption')">
                                        <i class="fi fi-rr-envelope-download"></i>
                                    </a>
                                    @endif
                                    @can('inquiry_fields')
                                    <a href="{{ route('inquiry.field.index', ['inquiryId' => $item['id']]) }}" class="btn icon-btn btn-sm btn-main" title="@lang('module/inquiry.field.caption')">
                                        <i class="fi fi-rr-form"></i>
                                    </a>
                                    @endcan
                                    @can('inquiry_update')
                                    <a href="{{ route('inquiry.edit', array_merge(['id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-success" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/inquiry.caption')
                                    ])">
            ...
            <div class="card-footer justify-content-center justify-content-lg-between align-items-center flex-wrap">
                <div class="text-muted mb-3 m-lg-0">
                    ...
                    <strong>{{ $data['inquiries']->firstItem() }}</strong> - 
                    <strong>{{ $data['inquiries']->lastItem() }}</strong> 
                    @lang('pagination.of')
