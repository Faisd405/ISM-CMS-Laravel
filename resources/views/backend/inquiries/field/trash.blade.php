                ...
                <table class="table card-table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $data['no']++ }}</td>
                            <td>
                                {!! Str::limit($item['label'][App::getLocale()], 30) !!} <code>({{ $item['name'] }})</code>
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-danger icon-btn btn-sm swal-delete" data-inquiry-id="{{ $item['inquiry_id'] }}" data-id="{{ $item['id'] }}" title="@lang('global.delete')">
