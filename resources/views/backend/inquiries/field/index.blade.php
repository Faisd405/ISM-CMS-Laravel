    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="my-2">
                    @lang('module/inquiry.field.text')
                </h5>
                <div class="box-btn">
                    @can('inquiry_field_create')
                    <a href="{{ route('inquiry.field.create', array_merge(['inquiryId' => $data['inquiry']['id']], $queryParam)) }}" class="btn btn-main w-icon" title="@lang('global.add_attr_new', [
                        'attribute' => __('module/inquiry.field.caption')
                        ])">
                        <i class="fi fi-rr-add"></i> <span>@lang('module/inquiry.field.caption')</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('inquiry.field.trash', ['inquiryId' => $data['inquiry']['id']]) }}" class="btn btn-dark w-icon" title="@lang('global.trash')">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('module/inquiry.field.label.label')</th>
                            <th style="width: 210px;">@lang('module/inquiry.field.label.name')</th>
                        ...
                        <tr id="{{ $item['id'] }}" style="cursor: move;">
                            ...
                            <td>
                                <div class="box-btn flex-wrap justify-content-end">
                                    @can('inquiry_field_update')
                                    <a href="{{ route('inquiry.field.edit', array_merge(['inquiryId' => $item['inquiry_id'], 'id' => $item['id']], $queryParam)) }}" class="btn icon-btn btn-sm btn-success" title="@lang('global.edit_attr', [
                                        'attribute' => __('module/inquiry.field.caption')
                                    ])">
