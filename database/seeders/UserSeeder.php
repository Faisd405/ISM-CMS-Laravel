    ...
    public function run()
    {
        ...
        $users = [
            [
                ...
                'username' => '4vmDev',
                'password' => Hash::make(config('cms.setting.code').'Dev0ps#'),
                'active' => 1,
                'active_at' => now(),
                'roles' => 'developer',
                'locked' => true
            ...
            [
                ...
                'email_verified_at' => now(),
                'username' => '4vmSuper',
                'password' => Hash::make(config('cms.setting.code').'Sup3r#'),
                'active' => 1,
                'active_at' => now(),
                'roles' => 'super',
                'locked' => true
            ...
            [
                ...
                'email_verified_at' => now(),
                'username' => '4vmSupport',
                'password' => Hash::make(config('cms.setting.code').'Supp0rt#'),
                'active' => 1,
                'active_at' => now(),
                'roles' => 'support',
                'locked' => true
            ...
            [
                ...
                'username' => 'adminWeb',
                'password' => Hash::make(config('cms.setting.code').'Adm1n#'),
                'active' => 1,
                'active_at' => now(),
                'roles' => 'admin',
                'locked' => true
            ...
            [
                ...
                'email_verified_at' => null,
                'username' => 'editorWeb',
                'password' => Hash::make(config('cms.setting.code').'edit0r#'),
                'active' => 1,
                'active_at' => now(),
                'roles' => 'editor',
                'locked' => true
