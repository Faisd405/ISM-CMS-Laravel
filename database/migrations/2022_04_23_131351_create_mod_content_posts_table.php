...
class CreateModContentPostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mod_content_posts', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('posted_by_alias')->nullable();
            ...
            $table->boolean('selected')->default(false)->comment('1 = selected, 0 not selected');
            ...
            $table->foreign('section_id')->references('id')
                ->on('mod_content_sections')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('mod_content_posts');
    }
}
