...
class CreateModGalleryCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mod_gallery_categories', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('album_perpage')->nullable();
    ...
    {
        Schema::dropIfExists('mod_gallery_categories');
    }
}
