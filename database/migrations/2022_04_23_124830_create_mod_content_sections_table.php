...
class CreateModContentSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mod_content_sections', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('category_perpage')->nullable();
            $table->json('config');
    ...
    {
        Schema::dropIfExists('mod_content_sections');
    }
}
