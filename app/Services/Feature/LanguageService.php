...
class LanguageService
{
    ...
    public function store($data)
    {
        try {
            ...
            $path = base_path('lang/'.$iso);
            File::makeDirectory($path, $mode = 0777, true, true);
            File::copyDirectory(base_path('lang/'.App::getLocale()), base_path('lang/'.$iso));
    ...
    public function update($data, $where)
    {
        ...
        try {
            ...
            if ($iso != $oldIso) {
                ...
                File::deleteDirectory(base_path('lang/'.$oldIso));
    ...
    public function delete($request, $where)
    {
        ...
        try {
            ...
            File::deleteDirectory(base_path('lang/'.$language['iso_codes']));
